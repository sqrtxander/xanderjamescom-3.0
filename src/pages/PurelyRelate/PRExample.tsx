    ...
    return (
        <div>
            ...
            <ul style={{ listStyleType: "-" }}>
                ...
                <li>
                    Each question has four clues, revealed from left to right.
                </li>
            ...
            <ul style={{ listStyleType: "-" }}>
                <li>This round has six questions.</li>
                <li>
                    Each question has three clues, revealed from left to right,
                    and one answer.
                </li>
            ...
            <ul style={{ listStyleType: "-" }}>
                ...
                <li>
                    The sixteen clues can be grouped into four related groups of
                    four.
                </li>
                ...
                <ul>
                    ...
                    <li>
                        2 bonus points if you found every group and identified
                        every relation.
                    </li>
                </ul>
            </ul>
            ...
            <ul style={{ listStyleType: "-" }}>
                <li>
                    This round has an undetermined number of sets of related
                    clues.
                </li>
                <li>
                    Each set of related clues has a relation given at the top.
                </li>
                <li>
                    Each clue in each set only shows its consonants, and the
                    spacing has been messed up.
                </li>
